...
function chanceHitting(steps) {
    let stepLeft = steps;
    let stepCount = 0;
    let initialChance = startChance(10, 30);
    console.log(`start chance: ${initialChance} %`);
    for (let i = 0; i < steps; i++) {
        initialChance = ((100 - initialChance) / stepLeft) + initialChance;
        stepLeft--;
        stepCount++;
        console.log(`Step: ${stepCount}; chance of hitting: ${initialChance} %`);
    }
}
